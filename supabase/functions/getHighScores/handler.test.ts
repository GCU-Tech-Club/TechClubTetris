...
Deno.test("handleGetHighScores - missing session token", async () => {
	...
	const response = await handleGetHighScores(undefined);
...
Deno.test("handleGetHighScores - invalid session token", async () => {
	...
	const response = await handleGetHighScores("invalid.token");
...
Deno.test({
	...
	const response = await handleGetHighScores(session.jwt);
